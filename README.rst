...
This sample demonstrates how to connect the Wi-Fi® station to a specified access point using Dynamic Host Configuration Protocol (DHCP).

After the connection is established, the device connects to a MQTT brocker server test.mosquitto.org(91.121.93.94) and publish data to the topic sensors
...
The sample also supports connection to an mqtt brocker server and publish data over topics.
...
The topics can be configured in the config.h file
